...
# Use environment variable for SECRET_KEY, fallback to a dev key (insecure!) for local development only.
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-h4r9b29iv8+#7z^(1i7n5rb+*%87^d00srf7v%1q*70#eo1@2e')
